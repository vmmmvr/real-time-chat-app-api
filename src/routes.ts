...
export default function (app: Express) {
  ...
  app.put(
    "/api/channels/:uuid",
    [validateRequest(updateChannelSchema), requireUser],
    updateChannelHandler
  );
  ...
  app.post(
    "/api/channels/join",
    [validateRequest(joinChannelSchema), requireUser],
    jointChannelHandler
  );
  ...
  app.post(
    "/api/rooms",
    [validateRequest(createRoomSchema), requireUser],
    createRoomHandler
  );
  ...
  app.post(
    "/api/rooms/room",
    [validateRequest(getRoomSchema), requireUser],
    getRoomHandler
  );

  // get  rooms
  app.get(
    "/api/rooms/all/:channeluuid",
    [validateRequest(getRoomsSchema), requireUser],
    getRoomsHandler
  );
  ...
  app.put(
    "/api/rooms/:roomuuid",
    [validateRequest(updateRoomSchema), requireUser],
    updateRoomHandler
  );
  ...
  app.delete(
    "/api/rooms/:roomuuid",
    [validateRequest(deleteRoomSchema), requireUser],
    deleteRoomHandler
  );
  ...
  app.post(
    "/api/messages",
    [validateRequest(createMessageSchema), requireUser],
